...
//        i9.add(jp);
        ...
        // jb3.addFocusListener(new CustomFocus());
...
//      t1.setText("Enter aadhar");
        t1.setFont(new Font("Raleway",Font.ITALIC,20));
//t1.addFocusListener(new CustomFocus());
...
//  class CustomFocus implements FocusListener {
//     @Override
//     public void focusGained(FocusEvent e) {
//         if (t1.getText().equals("Enter aadhar")) {
//             t1.setText("");
//             t1.setForeground(Color.black);
//         }
//
